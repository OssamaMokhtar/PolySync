  ...
  return (
    <div className="min-h-screen bg-[#0C0C0E] text-[#E4E4E7] flex flex-col items-center justify-center p-4 border-[10px] border-[#1A1A1E]">
      ...
      <div className="w-full max-w-xl mb-8">
        ...
        {/* Scope notice (replaces the clinical "special modes", UX-03) */}
        {step === 8 && (
          <div role="note" className="mt-4 bg-[#121215]/90 border border-[#27272A] rounded-xl p-4 text-sm text-[#E4E4E7]">
            <p className="font-medium">PolySync isn't built for medical situations yet</p>
            <p className="text-[#A1A1AA] mt-1">
              If you're pregnant or recently gave birth, taking medication that affects exercise, managing a medical condition,
              or recovering from an injury, please talk to a doctor or physiotherapist before you start.
            </p>
          </div>
        )}
