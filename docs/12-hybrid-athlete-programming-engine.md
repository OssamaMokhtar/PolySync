...
|---|---|---|---|---|
| H1 | Sequencing | Conflicting hard sessions on one day ≥ 6 h apart | Block | SCI-004, SCI-005 |
| H2 | Sequencing | No power work within 3 h after any endurance session | Block | SCI-003, SCI-004 |
| H3 | Priority | On a shared day, the block's priority quality goes first | Block | SCI-005 |
| H4 | Sequencing | Conflicting hard sessions < 24 h apart | Coach attention | SCI-005 |
| H5 | Load progression | Weekly load (minutes × RPE) > +10% over last week | Block → coach | SCI-006 (a product limit, **not** an injury claim; ADR-007) |
...
| H9 | Integrity | Malformed or injected proposals | Block | — |
...
Not built yet: macrocycle block sequencing, polarised or pyramidal intensity distribution, deload, taper and re-entry. They stay TBD until a coach signs the parameters.
