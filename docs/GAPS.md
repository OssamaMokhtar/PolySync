...
| 16 | Athlete onboarding offers clinical "special modes" (GLP-1, postpartum, injury rehab, 65+) that the strategy excludes, asks for health data before explaining consent, and does not ask the questions the hybrid engine needs | app/src/components/FitnessOnboarding.tsx | **High.** Scope and trust: no rule, eval or coach sign-off covers those populations | Medium | **Open — onboarding rebuild** ([UX review](13-ux-review.md) U1–U3) |
