...
| 2 | Coach minutes per athlete-month unmeasured | 11 | **Severe.** Decides software vs services | Medium | **Narrowed 2026-09-24** — [financial model](../product/financial-model.md) built on simulated escalation rates by schedule segment (ADR-008); real minutes come from the [pilot](../product/pilot-plan.md) |
...
| 14 | Escalation rates are simulated from the engine's own rules, not observed | 11 | Medium. The model's biggest driver is a simulation | Low (pilot measures it) | **Open — pilot** |
