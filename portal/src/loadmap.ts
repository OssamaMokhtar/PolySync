...
type Region = "quads" | "hamstrings" | "glutes" | "calves" | "hips" | "core";
const REGION_LABEL: Record<Region, string> = { quads: "Quads", hamstrings: "Hamstrings", glutes: "Glutes", calves: "Calves", hips: "Hip flexors", core: "Core" };
...
function regionLoads(w: HybridWeek) {
...
type Shape = { region?: Region; d: string };
...
const BODY: Record<"front" | "back", Shape[]> = {
  front: [
